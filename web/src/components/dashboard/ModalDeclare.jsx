 ...
 */
export default function ModalDeclare({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Simulation d'envoi
    console.log('Collaboration déclarée:', formData);
    setSubmitted(true);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
                <p className="text-sm text-bleu-nuit">
                  <strong>ℹ️ Information :</strong> Cette déclaration sera vérifiée par notre équipe avant validation définitive.
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-bleu-nuit text-white rounded-lg font-semibold hover:bg-bleu-nuit transition-all shadow-lg hover:shadow-xl"
                >
