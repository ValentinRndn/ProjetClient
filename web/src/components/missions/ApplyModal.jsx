    ...
    >
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          <div>
            <h2 id="apply-modal-title" className="text-2xl font-bold text-bleu-nuit">
          ...
          {submitted ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                L'école partenaire a été notifiée de votre intérêt pour cette mission.
              </p>
            </div>
          ) : (
            // Form
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-muted rounded-xl p-6 border border-gray-200">
                <h3 className="font-bold text-bleu-nuit mb-3">Récapitulatif de la mission</h3>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-gray-600">École</p>
                    <p className="font-semibold text-bleu-nuit">{mission.school}</p>
                  </div>
                  <div>
                    <p className="text-gray-600">Taux horaire</p>
                    <p className="font-semibold text-bleu-nuit">{mission.hourlyRate}€/h</p>
                  </div>
                  <div>
                    <p className="text-gray-600">Volume</p>
                    <p className="font-semibold text-bleu-nuit">{mission.volume}h</p>
                  </div>
                  <div>
                    <p className="text-gray-600">Montant total</p>
                    <p className="font-semibold text-bleu-nuit">{mission.totalAmount.toLocaleString()}€</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
                <p className="text-sm text-bleu-nuit">
                  <strong>ℹ️ Information :</strong> Votre candidature sera étudiée par l'école partenaire. Vous recevrez une réponse sous 48h.
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-bleu-nuit text-white rounded-lg font-semibold hover:bg-bleu-nuit transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Send size={18} />
