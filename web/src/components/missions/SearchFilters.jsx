  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-bleu-nuit">Recherche et filtres</h3>
          <p className="text-sm text-gray-600">Affinez votre recherche de missions</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-200">
        ...
        {/* Reset filters */}
        {(searchTerm || schoolFilter !== 'Toutes les écoles' || rateFilterIndex !== 0) && (
          <button
            onClick={() => {
              onSearchChange('');
