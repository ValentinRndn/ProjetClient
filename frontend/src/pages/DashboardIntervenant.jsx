...
// Data statique (contacts, partenaire)
const contacts = [
  {
...
const partnerOffer = {
  title: "Trouvez vos futurs alternants",
  description:
    "Découvrez notre partenaire Emage-me pour trouver vos futurs alternants.",
  buttonText: "Découvrir Emage-me",
  url: "https://jump.eu",
};
...
export default function DashboardIntervenant() {
  ...
  // Charger les missions de l'intervenant
  useEffect(() => {
    const loadMissions = async () => {
      ...
      try {
        ...
        const response = await missionService.getMyIntervenantMissions();
        ...
        // Transformer les missions pour correspondre au format attendu
        const transformedMissions = missionsList.map((mission) => ({
          ...
          school: mission.ecole?.name || "École non spécifiée",
        ...
        const totalRevenue = transformedMissions.reduce((sum, m) => {
        ...
        setStats({
          ...
          invoices: transformedMissions.length,
        });
      } catch (err) {
        ...
        if (err.response?.status === 401) {
          ...
          errorMessage =
            "Vous devez être connecté en tant qu'intervenant pour voir vos missions.";
        } else if (err.response?.status === 404) {
          errorMessage = "Aucune mission trouvée.";
        } else if (err.message) {
  ...
  return (
    <div className="min-h-screen bg-blanc-teinte">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div>
                <h1 className="text-bleu-nuit font-bold text-lg sm:text-xl">
                  Vizion Academy
                </h1>
                <p className="text-indigo-violet text-xs hidden sm:block">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
              <p className="text-sm text-bleu-nuit">
                <strong>ℹ️ Info :</strong> Dès que vous validez une mission avec
                l'école, pensez à la déclarer ici pour générer automatiquement
                votre facturation.
              </p>
            </div>
          </div>
          ...
          {!loading && (
            <section className="mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-3xl font-bold text-bleu-nuit">
                  Mes Missions
                </h2>
                <Link
                  to="/mur-missions"
              ...
              {missions && missions.length > 0 ? (
                ...
                <div className="bg-white rounded-xl border-2 border-dashed border-gray-300 p-12 text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Consultez le mur des missions pour découvrir les
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                ...
                <p className="text-3xl font-bold text-bleu-nuit mb-4">
              ...
              <div className="bg-gradient-to-br from-indigo-violet to-bleu-nuit rounded-xl shadow-md p-6 text-white">
                <p className="text-sm font-medium mb-2 text-white opacity-90">
              ...
              <div className="flex items-center justify-center gap-4 mb-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Mise en relation entre experts et établissements
                    d'enseignement
                  </p>
                </div>
              </div>
      ...
      <ModalDeclare isOpen={modalOpen} onClose={() => setModalOpen(false)} />
    </div>
  );
}
