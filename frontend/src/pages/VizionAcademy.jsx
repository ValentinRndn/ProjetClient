        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-bleu-pastel mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4">
              Vous cherchez des intervenants compétents et passionnés ?
              <br className="hidden sm:block" />
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-12 sm:mb-16 px-4">
              <button
                onClick={() => navigate("/trouver-intervenant")}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl mx-auto px-4">
            <div className="bg-white/15 backdrop-blur-xl rounded-2xl p-6 sm:p-8 text-center border border-white/30 shadow-2xl transform hover:scale-105 transition-all">
              <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-2 sm:mb-3 text-beige-elegant">
                35+
              </div>
              <div className="text-bleu-pastel font-medium text-sm sm:text-base">
                Écoles partenaires
              </div>
            </div>
            <div className="bg-white/15 backdrop-blur-xl rounded-2xl p-6 sm:p-8 text-center border border-white/30 shadow-2xl transform hover:scale-105 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-4">
              Pourquoi choisir{" "}
              <span className="bg-gradient-to-r from-bleu-intense to-indigo-violet bg-clip-text text-transparent">
                Vizion Academy
              </span>{" "}
              ?
            </h2>
            <p className="text-center text-bleu-nuit text-lg max-w-2xl mx-auto">
              Une plateforme pensée pour faciliter la collaboration entre écoles
              et experts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all border border-bleu-pastel hover:border-indigo-violet transform hover:-translate-y-2 group"
              >
                <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-gradient-to-br from-bleu-pastel to-blanc-teinte rounded-xl inline-block group-hover:scale-110 transition-transform">
                  {benefit.icon}
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-bleu-nuit">
                  {benefit.title}
                </h3>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-center text-bleu-nuit text-lg max-w-2xl mx-auto">
              Des experts dans tous les domaines clés de l'enseignement
              supérieur
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 px-4">
            {themes.map((theme, index) => (
              <span
                key={index}
                className="bg-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-full text-bleu-nuit font-semibold shadow-lg hover:shadow-2xl transition-all cursor-pointer border-2 border-bleu-pastel hover:border-indigo-violet transform hover:scale-110 text-xs sm:text-sm lg:text-base"
              >
                {theme}
              </span>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-4 px-4">
            {schools.map((school, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-bleu-pastel to-blanc-teinte px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-full text-bleu-intense font-bold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 border-2 border-bleu-pastel hover:border-indigo-violet text-xs sm:text-sm lg:text-base"
              >
                {school}
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all border-l-4 border-indigo-violet transform hover:-translate-y-2"
              >
                <div className="text-6xl text-bleu-pastel mb-4 font-serif">
                  "
                </div>
                ...
                <div className="border-t border-bleu-pastel pt-4">
                  <div className="font-bold text-bleu-nuit text-lg">
                    {testimonial.author}
                  </div>
                  <div className="text-sm text-bleu-intense">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto px-4">
            <div className="bg-white/15 backdrop-blur-xl rounded-3xl p-6 sm:p-8 lg:p-10 border-2 border-white/30 hover:bg-white/20 transition-all transform hover:scale-105 shadow-2xl">
              ...
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-extrabold mb-3 sm:mb-4">
                Pour les écoles
              </h3>
              <p className="text-bleu-pastel mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed">
                Accédez à notre réseau d'experts qualifiés et explorez vos
                projets innovants clés en main
              </p>
              <button
                onClick={() => navigate("/trouver-intervenant")}
            ...
            <div className="bg-white/15 backdrop-blur-xl rounded-3xl p-6 sm:p-8 lg:p-10 border-2 border-white/30 hover:bg-white/20 transition-all transform hover:scale-105 shadow-2xl">
              ...
              <p className="text-bleu-pastel mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed">
                Rejoignez notre communauté d'experts et partagez votre passion
                avec les étudiants
              </p>
              <button
                onClick={() => navigate("/creer-profil-intervenant")}
                className="bg-beige-elegant text-bleu-nuit px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold hover:bg-blanc-teinte transition-all w-full shadow-xl hover:shadow-2xl transform hover:scale-105 text-sm sm:text-base"
              >
                Créer un profil →
              </button>
            </div>
