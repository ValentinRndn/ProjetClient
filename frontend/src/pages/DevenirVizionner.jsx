...
const FaqItem = ({ question, answer, isOpen, onToggle }) => (
  <div className="bg-white rounded-xl border border-bleu-pastel overflow-hidden shadow-sm hover:shadow-md transition-all">
    ...
    >
      ...
      <ChevronDown
        className={`w-5 h-5 text-indigo-violet transition-transform flex-shrink-0 ${
          isOpen ? "rotate-180" : ""
        }`}
        aria-hidden="true"
      />
  ...
  const features = [
    {
      ...
      description:
        "Partagez vos connaissances et votre expérience professionnelle avec la prochaine génération de talents.",
    },
    {
      icon: <Calendar className="w-8 h-8 text-bleu-intense" />,
      title: "Flexibilité totale",
      description:
        "Choisissez vos créneaux et interventions selon votre emploi du temps et vos disponibilités.",
    },
    {
      icon: <FileText className="w-8 h-8 text-bleu-intense" />,
      title: "Gestion simplifiée",
      description:
        "Nous prenons en charge toute la partie administrative : facturation, contrats et paiements.",
    },
    {
      icon: <User className="w-8 h-8 text-bleu-intense" />,
      title: "Réseau professionnel",
      description:
        "Rejoignez une communauté d'experts passionnés et développez votre réseau professionnel.",
    },
  ];
  ...
  const timelineSteps = [
    {
      ...
      description:
        "Remplissez votre profil en quelques minutes : domaines d'expertise, expérience, disponibilités.",
    },
    {
      number: "2",
      title: "Validation de votre profil",
      description:
        "Notre équipe vérifie vos qualifications et valide votre profil sous 48h maximum.",
    },
    {
      number: "3",
      title: "Recevez des opportunités",
      description:
        "Les écoles consultent votre profil et vous proposent des missions adaptées à votre expertise.",
    },
    {
      number: "4",
      title: "Intervenez et partagez",
      description:
        "Acceptez les missions qui vous intéressent et transmettez votre savoir aux étudiants.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Vous devez avoir au moins 3 ans d'expérience professionnelle dans votre domaine, une expertise reconnue et la passion de transmettre vos connaissances. Un niveau d'études minimum Bac+3 est recommandé.",
    },
    {
      question: "Comment suis-je rémunéré pour mes interventions ?",
      answer:
        "La rémunération est fixée en accord avec l'école et dépend du type d'intervention, de la durée et de votre niveau d'expertise. Vizion Academy prend en charge toute la facturation et vous verse directement vos honoraires.",
    },
    {
      question: "Puis-je choisir mes missions et mes horaires ?",
      answer:
        "Absolument ! Vous êtes totalement libre de choisir les missions qui vous intéressent et de définir vos disponibilités. Vous n'avez aucune obligation d'accepter toutes les propositions.",
    },
    {
      question: "Quel type d'interventions puis-je réaliser ?",
      answer:
        "Les interventions sont variées : cours magistraux, ateliers pratiques, conférences, jurys d'examen, encadrement de projets étudiants, mentorat, etc. Tout dépend de votre expertise et des besoins des écoles.",
    },
    {
      question: "Y a-t-il des frais pour s'inscrire ?",
      answer:
        "Non, l'inscription sur Vizion Academy est 100% gratuite pour les intervenants. Nous ne prenons aucune commission sur vos honoraires.",
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl md:text-2xl text-bleu-pastel leading-relaxed">
                  Partagez votre expertise avec la nouvelle génération
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-bleu-nuit mb-4">
              Pourquoi devenir{" "}
              <span className="text-indigo-violet">Vizionner</span> ?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Rejoignez une communauté d'experts passionnés et profitez de
              nombreux avantages
            </p>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-bleu-nuit mb-4">
              Comment rejoindre{" "}
              <span className="text-indigo-violet">Vizion Academy</span> ?
            </h2>
          ...
          <div className="bg-beige-elegant rounded-3xl p-8 md:p-12 shadow-2xl border-4 border-beige-elegant/50">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Expertise professionnelle :</strong> Minimum 3 ans
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Formation académique :</strong> Diplôme Bac+3
                    minimum recommandé ou expérience équivalente
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Langues parlées :</strong> Indiquez les langues que
                    vous maîtrisez pour vos interventions (Français, Anglais,
                    Espagnol, etc.)
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Modalités d'intervention :</strong> Précisez si vous
                    intervenez en distanciel, présentiel ou les deux
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Passion pour la transmission :</strong> Envie de
                    partager vos connaissances et d'accompagner les étudiants
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <p className="text-bleu-nuit font-medium">
                    <strong>Disponibilité :</strong> Capacité à intervenir
                    régulièrement ou ponctuellement selon vos préférences
                  </p>
                </div>
              </div>
            </div>{" "}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border-2 border-bleu-nuit">
              <div className="flex gap-3 items-start">
                <div className="flex-shrink-0">
                  <Check className="w-6 h-6 text-bleu-nuit" />
                </div>
                <div>
                  <h3 className="font-bold text-bleu-nuit mb-2">
                    Important à savoir
                  </h3>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Tous nos intervenants sont vérifiés et sélectionnés avec
                    soin. Nous privilégions la qualité et l'adéquation entre
                    votre profil et les besoins des établissements partenaires.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-bleu-nuit mb-4">
              Ils sont déjà{" "}
              <span className="text-indigo-violet">Vizionners</span>
            </h2>
            <p className="text-xl text-gray-600">
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-bleu-nuit via-bleu-intense to-indigo-violet">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-bleu-pastel mb-10 leading-relaxed">
            Créez votre profil dès maintenant et commencez à partager votre
            expertise
