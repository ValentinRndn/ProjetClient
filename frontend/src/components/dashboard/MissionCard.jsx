    ...
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all border border-gray-200 p-6">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <h3 className="text-xl font-bold text-bleu-nuit mb-1">
            {mission.module || mission.title || "Mission sans titre"}
          </h3>
          <div className="flex items-center gap-2 text-gray-600">
            <MapPin size={16} />
            <span className="text-sm">
              {mission.school || "École non spécifiée"}
            </span>
          </div>
        </div>
        <span
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="flex items-center gap-2 text-gray-600">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-bleu-nuit">
              {Number(mission.remuneration || 0).toFixed(2)}€
            </p>
          </div>
        </div>
      </div>
