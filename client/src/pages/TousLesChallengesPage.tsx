      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="bg-[#fdf1f7] rounded-lg p-6 mb-6">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                <Zap className="w-4 h-4 mt-1 text-[#6d74b5]" />
                <span>Accompagnement pédagogique complet</span>
              </li>
              <li className="flex items-start gap-2">
                <Target className="w-4 h-4 mt-1 text-[#6d74b5]" />
                <span>Livrables et grilles d'évaluation</span>
              </li>
              <li className="flex items-start gap-2">
                <Trophy className="w-4 h-4 mt-1 text-[#6d74b5]" />
                <span>Lots et récompenses pour les étudiants</span>
              </li>
              <li className="flex items-start gap-2">
                <Lightbulb className="w-4 h-4 mt-1 text-[#6d74b5]" />
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button variant="primary" className="flex-1 bg-[#6d74b5] hover:bg-[#5a61a0]">
              Demander un devis
            </Button>
...
export default function TousLesChallengesPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative text-white py-16 overflow-hidden" style={{ backgroundColor: "#1c2942" }}>
        <div
        ...
        <PageContainer maxWidth="7xl" className="relative z-10">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto">
              Des projets pédagogiques innovants et clé en main pour dynamiser l'apprentissage de vos étudiants.
            </p>
          </div>
        </PageContainer>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
              ...
              <select
                ...
                className="w-full sm:w-auto px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#6d74b5] transition appearance-none bg-white cursor-pointer"
              >
                {levels.map((level) => (
